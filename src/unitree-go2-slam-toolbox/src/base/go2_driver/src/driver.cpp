...
private:
    ...
    {   
        ...
        const double yaw = tf2::getYaw(pose_q);

        tf2::Quaternion planar_q;
        planar_q.setRPY(0.0, 0.0, yaw);
        planar_q.normalize();
        ...
        transform.transform.rotation.x = planar_q.x();  
        transform.transform.rotation.y = planar_q.y();  
        transform.transform.rotation.z = planar_q.z();  
        transform.transform.rotation.w = planar_q.w();  
        ...
        odom.pose.pose.orientation.x = planar_q.x();    
        odom.pose.pose.orientation.y = planar_q.y();    
        odom.pose.pose.orientation.z = planar_q.z();    
        odom.pose.pose.orientation.w = planar_q.w();    
